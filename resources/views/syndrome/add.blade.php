                ...
                <div class="panel-body">
                    <form class="pure-form pure-form-aligned js-slidetitlebanners">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="syndrome_name" type="text" class="form-control" id="anagraphName" autocomplete="off" value="" placeholder="证候">
                            </div>
                        </div>
                        <div class="ml5 mt10 form-group">
                            <label for="syndrome_desc" class="col-sm-2 control-label">证候描述:</label>
                            <div class="col-sm-10">
                                <input name="syndrome_desc" type="text" class="form-control" id="anagraphOrigin" autocomplete="off" value="" placeholder="证候描述">
                            </div>
                        </div>
                        <div class="form-group">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr class="js-slide_syndrome_block">
                                        <th scope="row"></th>
                                        <td><input name="alias[][syndrome_alias]" class="" type="text" autocomplete="off" value="" /></td>
                                        <td><button class="btn btn-danger js-del_syndrome" onclick="">删除</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="form-group">
                            <input class="btn btn-success js-add_syndrome" type="button" value="增加" />
                    ...
                    <script>
                        ...
                        function doSaveData(data){
                            $.post("{{ config('medicine.base_url') }}/createSyndrome", {'_token':'{{csrf_token()}}', 'data':data}, function(res){
                                // res = $.parseJSON(res);
                                // if (res == '0') {
                                //     alert('提交出错，请重新编辑');
                                // }else {
